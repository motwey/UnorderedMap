#ifndef UNORDEREDMAP_UMAP_H
#define UNORDEREDMAP_UMAP_H
...
template<typename T, typename Allocator>
template<bool isConst>
typename _List<T, Allocator>::template common_iterator<isConst> &
_List<T, Allocator>::common_iterator<isConst>::operator++() {
    adress = adress->next;
    return *this;
}
...
template<bool isConst>
typename _List<T, Allocator>::template common_iterator<isConst>
_List<T, Allocator>::common_iterator<isConst>::operator++(int) {
...
UnorderedMap<Key, Value, Hash, Equal, Alloc>::UnorderedMap(): alloc(BucketAlloc()),
                                                              ...
                                                              _max_load_factor(STANDART_MAX_LOAD_FACTOR),
                                                              items(ListType()),
...
template<typename Key, typename Value, typename Hash, typename Equal, typename Alloc>
template<bool isConst>
typename UnorderedMap<Key, Value, Hash, Equal, Alloc>::template common_iterator<isConst> &
UnorderedMap<Key, Value, Hash, Equal, Alloc>::common_iterator<isConst>::operator++() {
    ++list_node;
    return *this;
}
